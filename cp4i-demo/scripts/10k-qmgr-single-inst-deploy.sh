...
( echo "cat <<EOF" ; cat instances/${CP4I_VER}/33-qmgr-single-instance.yaml ;) | \
OCP_BLOCK_STORAGE=${OCP_BLOCK_STORAGE} \
MQ_VERSION=${MQ_VERSION} \
sh > 33-qmgr-single-instance.yaml
echo "Deploying Queue Manager instance..."
oc apply -f 33-qmgr-single-instance.yaml -n ${QMGR_NAMESPACE}
echo "Cleaning up temp files..."
rm -f 33-qmgr-single-instance.yaml
