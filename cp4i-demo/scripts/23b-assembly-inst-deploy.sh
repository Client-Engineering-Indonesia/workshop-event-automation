...
( echo "cat <<EOF" ; cat instances/${CP4I_VER}/03-assembly-demo-product-ir.yaml ;) | \
    APIC_CREDENTIALS=${APIC_CREDENTIALS} \
    APIC_PROVIDER_ORG=${APIC_PROVIDER_ORG} \
    OCP_BLOCK_STORAGE=${OCP_BLOCK_STORAGE} \
    sh > 03-assembly-demo-product-ir.yaml
echo "Deploying Assembly..."
oc apply -f 03-assembly-demo-product-ir.yaml -n ${ACE_NAMESPACE}
echo "Cleaning up temp files..."
rm -f 03-assembly-demo-product-ir.yaml
