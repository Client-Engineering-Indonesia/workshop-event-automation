...
( echo "cat <<EOF" ; cat instances/${CP4I_VER}/02-assembly-demo-product-ir.yaml ;) | \
    APIC_CREDENTIALS=${APIC_CREDENTIALS} \
    APIC_PROVIDER_ORG=${APIC_PROVIDER_ORG} \
    OCP_BLOCK_STORAGE=${OCP_BLOCK_STORAGE} \
    sh > 02-assembly-demo-product-ir.yaml
echo "Deploying Assembly..."
oc apply -f 02-assembly-demo-product-ir.yaml -n ${ACE_NAMESPACE}
echo "Cleaning up temp files..."
rm -f 02-assembly-demo-product-ir.yaml
