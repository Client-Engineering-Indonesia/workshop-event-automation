...
if [ "$CP4I_VER" != "16.1.0" ] && [ "$CP4I_VER" != "16.1.1" ]; then echo "This script is for CP4I v16.1.0"; exit 1; fi;
...
( echo "cat <<EOF" ; cat instances/${CP4I_VER}/05-event-streams-instance.yaml ;) | \
OCP_BLOCK_STORAGE=${OCP_BLOCK_STORAGE} \
sh > 05-event-streams-instance.yaml
echo "Deploying Event Streams instance..."
oc apply -f 05-event-streams-instance.yaml -n ${ES_NAMESPACE}
