...
( echo "cat <<EOF" ; cat instances/${CP4I_VER}/02-asset-repo-ai-instance.yaml ;) | \
OCP_BLOCK_STORAGE=${OCP_BLOCK_STORAGE} \
sh > 02-asset-repo-ai-instance.yaml
echo "Deploying Asset Repo instance..."
oc apply -f 02-asset-repo-ai-instance.yaml -n ${ASSET_REPO_NAMESPACE}
echo "Cleaning up temp files..."
rm -f 02-asset-repo-ai-instance.yaml
