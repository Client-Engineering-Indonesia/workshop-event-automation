...
( echo "cat <<EOF" ; cat instances/${CP4I_VER}/12-qmgr-native-ha-instance.yaml ;) | \
OCP_BLOCK_STORAGE=${OCP_BLOCK_STORAGE} \
MQ_VERSION=${MQ_VERSION} \
sh > 12-qmgr-native-ha-instance.yaml
echo "Deploying Queue Manager instance..."
oc apply -f 12-qmgr-native-ha-instance.yaml -n ${QMGR_NAMESPACE}
echo "Cleaning up temp files..."
rm -f 12-qmgr-native-ha-instance.yaml
